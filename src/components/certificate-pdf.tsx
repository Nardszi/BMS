  ...
  return (
    ...
    >
      ...
      >
        ...
        <img src="/barangay-seal.png" alt="" style={{ width: 300, height: 300, objectFit: "contain" }} />
      </div>
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 24 }}>
          <div style={{ display: "flex", justifyContent: "center", marginBottom: 8 }}>
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/barangay-seal.png" alt="Seal" style={{ width: 70, height: 70, objectFit: "contain" }} />
          </div>
          <p style={{ fontSize: 11, textTransform: "uppercase", letterSpacing: 1, margin: 0 }}>Republic of the Philippines</p>
          <p style={{ fontSize: 11, textTransform: "uppercase", letterSpacing: 1, margin: 0 }}>City of Victorias</p>
          <p style={{ fontSize: 11, textTransform: "uppercase", letterSpacing: 1, margin: 0 }}>Negros Occidental</p>
          <p style={{ fontSize: 13, fontWeight: 700, textTransform: "uppercase", letterSpacing: 1.5, marginTop: 8 }}>
        ...
        {/* Body */}
        <div style={{ fontSize: 13, lineHeight: 1.8, marginBottom: 32 }}>
          {c.type === "CLEARANCE" && (
            <>
              <p>TO WHOM IT MAY CONCERN:</p>
              <p style={{ textAlign: "justify", textIndent: 40 }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", fontSize: 13, marginBottom: 32 }}>
          <div style={{ textAlign: "center" }}>
            ...
            <div style={{ marginTop: 40, borderTop: "1px solid #94a3b8", paddingTop: 4 }}>
