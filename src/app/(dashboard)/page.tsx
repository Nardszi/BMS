      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <CardContent className="p-5">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-1 text-3xl font-bold text-gray-900">{stats.totalResidents}</p>
                <p className="mt-1 text-xs text-gray-400">Registered inhabitants</p>
              </div>
          ...
          <CardContent className="p-5">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-1 text-3xl font-bold text-gray-900">{stats.pendingCertificates}</p>
        ...
        <Card className="relative overflow-hidden border-0 shadow-md transition-shadow hover:shadow-lg">
          ...
          <CardContent className="p-5">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-500">Open Blotter Cases</p>
                <p className="mt-1 text-3xl font-bold text-gray-900">{stats.openBlotterCases}</p>
                <p className="mt-1 text-xs text-gray-400">Active investigations</p>
              </div>
          ...
          <CardContent className="p-5">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-1 text-3xl font-bold text-gray-900">{stats.activePermits}</p>
                <p className="mt-1 text-xs text-gray-400">Operating businesses</p>
              </div>
        ...
        <Card className="lg:col-span-1 border-0 shadow-md">
          ...
          <CardContent className="space-y-2">
            <Link href="/residents" className="group flex items-center gap-3 rounded-lg border p-3 transition-all hover:border-blue-200 hover:bg-blue-50">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium text-gray-900">Manage Residents</p>
                <p className="text-xs text-gray-500">View and update records</p>
              </div>
            ...
            <Link href="/certificates" className="group flex items-center gap-3 rounded-lg border p-3 transition-all hover:border-amber-200 hover:bg-amber-50">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-500">Issue and track requests</p>
              </div>
              <ArrowRight className="h-4 w-4 text-gray-400 transition-transform group-hover:translate-x-1 group-hover:text-amber-600" />
            </Link>
            <Link href="/blotter" className="group flex items-center gap-3 rounded-lg border p-3 transition-all hover:border-red-200 hover:bg-red-50">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium text-gray-900">Blotter Reports</p>
                <p className="text-xs text-gray-500">File and manage cases</p>
              </div>
            ...
            <Link href="/reports" className="group flex items-center gap-3 rounded-lg border p-3 transition-all hover:border-emerald-200 hover:bg-emerald-50">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-500">View analytics and stats</p>
              </div>
                ...
                {stats.recentCertificates.slice(0, 5).map((cert) => (
                  <div key={cert.id} className="flex items-center justify-between rounded-lg border p-3">
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-xs text-gray-500">{typeLabels[cert.type] || cert.type}</p>
                    </div>
